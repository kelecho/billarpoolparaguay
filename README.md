...
- Los pases libres se propagan solos por la llave de perdedores y se conocen desde el sorteo. Son relleno para que el cuadro cierre cuando los inscriptos no son potencia de 2, así que no se dibujan: quien pasa directo aparece en su primer partido real y el cuadro avisa arriba quiénes son. No quitan ningún choque: con gran final única siempre se juegan 2 × inscriptos − 2 partidos, se arme como se arme.
