...
- Insignias de categoría con forma de rombo, el diamante de la baranda de la mesa: marco de oro para Primera, acero para Segunda, cobre para Tercera y hueso para Principiante, con el numeral romano sobre el azul de club. Se actualizan con la categoría del jugador y también aparecen en los filtros y el ranking. Se regeneran con `python3 scripts/generate-badges.py` (necesita `pip install fonttools brotli`).
